...
CURRDIR: str | list[str] = os.environ[
    "USER" if platform.system() != "Windows" else "USERPROFILE"
]
...
ARTISTS = ["Dishant B for the app icon", "Le Bao Nguyen for app assets (tooltips etc)"]
